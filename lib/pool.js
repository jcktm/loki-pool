...
// The Loki address prefixes we use to detect malformed wallet addresses.
var lokiWalletBase58AddressPrefix = '114';
var lokiWalletBase58SubAddressPrefix = '116';
var lokiTestnetWalletBase58AddressPrefix = '156';
var lokiTestnetWalletBase58SubAddressPrefix = '158';
var lokiStagenetWalletBase58AddressPrefix = '24';
var lokiStagenetWalletBase58SubAddressPrefix = '26';
...
function handleMinerMethod(method, params, ip, portData, sendReply, pushMessage){
    ...
    switch(method){
        case 'login':
            ...
            var expectedAddressPrefix = config.poolServer.testnet  ? lokiTestnetWalletBase58AddressPrefix
                                      : config.poolServer.stagenet ? lokiStagenetWalletBase58AddressPrefix
                                                                   : lokiWalletBase58AddressPrefix;
            var expectedSubAddressPrefix = config.poolServer.testnet  ? lokiTestnetWalletBase58SubAddressPrefix
                                         : config.poolServer.stagenet ? lokiStagenetWalletBase58SubAddressPrefix
                                                                      : lokiWalletBase58SubAddressPrefix;
            if (addressPrefix != expectedAddressPrefix && addressPrefix != expectedSubAddressPrefix) {
